...
namespace EmpireClash
{
    ...
    public partial class UIManager : MonoBehaviour
    {
        ...
        void Start()
        {
            ...
            {
                mainMenuPanel.SetUIManager(this);
        ...
        {
            UIPanel[] panels = { mainMenuPanel, buildingPanel, unitPanel, techPanel, levelPanel };
            ...
            foreach (var panel in panels)
            {
                ...
                {
                    panel.Init();
                    // 立即强制隐藏，避免 isShowing 判断导致第一次无法真正隐藏
                    panel.HideImmediate();
                }
            }
        ...
        public void ShowAttackLevels()
        {
            ShowLevelPanel(LevelType.Attack);
        }

        public void ShowDefenseLevels()
        {
            ShowLevelPanel(LevelType.Defense);
        }

        private void ShowLevelPanel(LevelType levelType)
        {
            // TODO: 可根据 levelType 过滤关卡

...
namespace EmpireClash
{
    ...
    public class EquipmentManager : MonoBehaviour
    {
        ...
        public void AddEquipment(string equipmentId)
        {
            ...
            GameManager.Instance?.UIManager?.ShowNotification($"获得装备: {equipmentData.equipmentName}");
        }
        ...
        public bool EquipItem(string equipmentId)
        {
            ...
            {
                GameManager.Instance?.UIManager?.ShowNotification("等级不足，无法装备");
                return false;
            }
        ...
        public bool EnhanceEquipment(string equipmentId)
        {
            ...
            if (resourceManager != null)
            {
                ...
                {
                    GameManager.Instance?.UIManager?.ShowNotification("金币不足");
                    return false;
                }
            ...
            GameManager.Instance?.UIManager?.ShowNotification($"装备强化成功！+{equipment.enhancementLevel}");

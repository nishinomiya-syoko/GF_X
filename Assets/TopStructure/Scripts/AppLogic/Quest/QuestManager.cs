...
namespace EmpireClash
{
    ...
    public class QuestManager : MonoBehaviour
    {
        ...
        public bool AcceptQuest(string questId)
        {
            ...
            // 检查是否可以接受任务
            int playerLevel = GameManager.Instance?.LevelManager?.playerLevel ?? 1;
            ...
            GameManager.Instance?.UIManager?.ShowNotification($"任务已接受: {questData.questName}");
        ...
        public bool CompleteQuest(string questId)
        {
            ...
            GameManager.Instance?.UIManager?.ShowNotification($"任务完成: {questData.questName}");
        ...
        private void GrantQuestReward(QuestReward reward)
        {
            ...
            {
                GameManager.Instance?.LevelManager?.AddExperience(reward.experience);
            }
        ...
        public void UnlockAchievement(string achievementId)
        {
            ...
            GameManager.Instance?.UIManager?.ShowNotification($"成就解锁: {achievement.achievementName}");
        }
        ...
        private void GenerateDailyQuests()
        {
            ...
            if (dailyQuests != null)
            {
                ...
                for (int i = 0; i < questCount; i++)
                {
                    ...
                    if (quest.CanAccept(GameManager.Instance?.LevelManager?.playerLevel ?? 1, completedQuests))
                    {
